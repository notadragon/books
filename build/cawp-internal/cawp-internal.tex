...
\include{common-internal-initial}
...
\include{common-internal-preamble}
...
\externaldocument{cawp-application-developers}
\externaldocument{cawp-library-writers}
\externaldocument{cawp-writing-allocators}
\externaldocument{cawp-advanced}
\externaldocument{cawp-appendix}
\externaldocument{common-internal-initial}
\externaldocument{common-internal-preamble}
\externaldocument{common-internal-back}
...
\cleardoublepage                  % This command is defined in our documentclass file. It tells
                                  ...
                                  % page if needed.
\include{cawp-half-title}              % The half-title page
\include{cawp-series}                  % A placeholder for the series page. The publisher normally
                                  % creates this page and just adds it into the final PDF.
\include{cawp-title}                   % The title page
\include{cawp-CIP}                     % The cataloging-in-publication page
\include{cawp-dedication}              % The dedication page
\cleardoublepage
...
\include{cawp-foreword}                % Add foreword
\include{cawp-preface}                 % Add preface
\include{cawp-ack}                     % Add acknowledgements
\include{cawp-author}                  % Add about the author page
...
\include{cawp-application-developers}
\include{cawp-library-writers}
\include{cawp-writing-allocators}
\include{cawp-advanced}
...
\bibliography{cawp-bib}  % Loading the bibliography file.
...
%
\include{cawp-appendix}
\include{common-internal-back}
%%%%%%% Back matter ends
