// ap1int_simple4.cpp                                                 -*-C++-*-
#include <ap1int_simple4.h>

#include <bsls_ident.h>
BSLS_IDENT_RCSID(ap1int_simple4_cpp,"$Id$ $CSID$")
...
{
//-----------------------------------GENERATED EXTRACT : ap1 ap1int_simple4_cpp
// ----Listing start: ap1-body.tex:43-----
    bdlma::LocalSequentialAllocator<2048> alloc;
    bsl::set<char> uniq(&alloc);
// ----Listing done: ap1-body.tex:46-----
//-------------------------------END GENERATED EXTRACT : ap1 ap1int_simple4_cpp
    return uniq.size();
}
