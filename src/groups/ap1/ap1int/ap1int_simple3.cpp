// ap1int_simple3.cpp                                                 -*-C++-*-
#include <ap1int_simple3.h>

#include <bsls_ident.h>
BSLS_IDENT_RCSID(ap1int_simple3_cpp,"$Id$ $CSID$")
...
{
//-----------------------------------GENERATED EXTRACT : ap1 ap1int_simple3_cpp
// ----Listing start: ap1-body.tex:35-----
    bdlma::SequentialAllocator alloc;
    bdlma::CountingAllocator countingAlloc(&alloc);
    bsl::set<char> uniq(&countingAlloc);
// ----Listing done: ap1-body.tex:39-----
//-------------------------------END GENERATED EXTRACT : ap1 ap1int_simple3_cpp
    return uniq.size();
}
