...
themselves. Determining which of the \emcppsgloss{special member functions}
...
\emcppsgloss{special member functions} accordingly.
...
\begin{itemize}
\item{\seealsoref{deleted-functions}{\seealsolocationa}describes a companion feature, \lstinline!=!\,\lstinline!delete!, that can be used to suppress access to implicitly generated \emcppsgloss{special member functions}.}
...
\item{\seealsoref{Rvalue-References}{\seealsolocationc}provides the bases for \emcppsgloss{move operations}, namely, the move-constructor and move-assignment \emcppsgloss{special member functions}, which too can be defaulted.}
\end{itemize}
