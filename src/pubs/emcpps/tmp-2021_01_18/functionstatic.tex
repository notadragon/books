...
{ball} package of the {bal} package group of Bloomberg's open-source
  BDE libraries (\cite{bde14}, subdirectory \texttt{/groups/ball/bal}).}}
...
initialization of \romeogloss{function-scope} \romeogloss{static-duration}
...
\noindent Depending on the compiler or the link line, the call from \lstinline!main.o! into \lstinline!libcomp.o! may occur and
...
them as explicit arguments. Similarly to example introduced in \intraref{description-functionstatic}{logger-example}, consider a
...
across translation units an abundant source insidious errors. Objects that undergo \romeogloss{constant initialization} have no issue:
