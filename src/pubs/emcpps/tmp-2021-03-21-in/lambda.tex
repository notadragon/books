...
void f3()
{
    ...
    auto c1 = []{ return typeid(x); };
        // This is potentially an error: (ù{\codeincomments{x}}ù) was not captured
}
\end{emcppslisting}
...
{
    int x = 0;
    auto& xid = typeid(x);         // OK, (ù{\codeincomments{typeid}}ù) called outside of lambda
    auto c1 = [&]{ return xid; };  // OK, return captured (ù{\codeincomments{typeinfo}}ù)
}
\end{emcppslisting}
