...
{
    il = { 4, 5, 6, 7 };  // (ù{\codeincomments{il}}ù) has dangling reference to a temporary array
}
\end{emcppslisting}
...
#include <vector>  // (ù{\codeincomments{std::vector}}ù)
#include <cassert>  // standard C (ù{\codeincomments{assert}}ù) macro
#include <cstring>  // (ù{\codeincomments{std::memcmp}}ù)
\end{emcppshiddenlisting}
...
#include <algorithm>         // (ù{\codeincomments{std::min}}ù)
#include <initializer_list>  // (ù{\codeincomments{std::initializer\_list}}ù)
