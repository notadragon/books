...
% 01 Feb, 2021 JMB - added a missing include to hidden listing (line 88)
% 09 Feb 2021, FPPs set
% 17 Feb 2021, glossary tags would have been updated, but there are zero glossary entries in this feature. 

\emcppsFeature{
toclong={Consecutive Right-Angle Brackets},
tocshort={Consecutive {\TOCCode >}s},
short={Consecutive \lstinline!>!s},
long={Consecutive Right-Angle Brackets},
rhshort={Consecutive {\RHCode >}s},
