...
%\documentclass[twoside,10pt,letterpaper,xetex,usenames]{newstyle-PearsonGeneric-7-38-ROMEO}
...
\newfontface{\RHCode}[Ligatures=NoCommon,Scale=.81]{Cousine Regular} %%% if the RH contains a code, then we must use \sectionmark and intentionally set that code word in \RHCode font; otherwise, the code word will be set in a font size too large. 
...
commentstyle={\color{PANTONE661PC}\itshape},
...
%%%%%%%%%%%%
\newcommand{\codeincomments}{\color{PANTONE661PC}\ttfamily}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
