...
struct Lt  // literal type
{
   ...
   constexpr ~Lt() = default;  // (ù{\codeincomments{default}}ù) trivial destructor
};
...
struct Nlt  // (ù{\emphincomments{non}ù)literal type.
{
    ...
    ~Lt() { }  // cannot skip non-trivial destruction
};
...
int hoursToSeconds1(int hours)
    // ...
{
    return hours * TimeRatios::k_SECONDS_PER_HOUR;
}
\end{emcppslisting}
...
{
    return hours * TimeRatios::k_NANOS_PER_HOUR;
}
\end{emcppslisting}
