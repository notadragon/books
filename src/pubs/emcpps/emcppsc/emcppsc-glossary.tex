...
%    }}
%    ```
%     id - The id of the entry, do not alter this.  Acronyms and initialiasims
%          should be upper case, all other words should be lower case, no markup.
%     name - The name to be displayed in the glossary.
%     description - The description to be displayed.
% * Keep descriptions brief, readable.
% * Use markdown style when adding new descriptions
% * Only cross-reference a section if that section has a deep well of extra
%   information on that glossary term.
% * If there is a family of terms and not all terms are here, feel free to
%   add them.  Order doesn't matter.
% * Acronyms and Initialisms should include their expansion in the name field
%   (in parenthesis).
...
\AtBeginDocument{\glsadd{alignment}}
...
%  name={\ParaCode{inline} \ParaCode{namespace}},
