%(grep "Glossary entry" ../../../../build/emcpps/emcpps-internal/emcpps-internal/emcpps-internal.log  | uniq | sed -e "s/.*\`//" -e "s/'.*//") | while read gt ; do echo "\longnewglossaryentry{${gt}}{" ; echo "  name={${gt}}," ; echo "  description={" ; echo "TODO" ; echo "}}" ; echo ; done

% glossary term referencing itself: ***xyz***
% glossary term referenced:  **abc**

\longnewglossaryentry{ABI}{
  name={Application Binary Interface (ABI)},
  description={
%DRAFT JMB  
  The aspects of a library interface that are utlized in the generation of client
  code.  Include the object layout of classes and structs as well as the calling
  conventions, parameters, return types, and name mangling of functions.  In general,
  two libraries with the same ***ABI*** can be interchanged with only the need to relink
  but not to recompile client code.
}}
...
\longnewglossaryentry{API}{
  ...
  description={
%DRAFT JMB
  The interface for a library that is exposed to client code for programming.
  Two libraries, or different versions of the same library, with the same API
  can be interchanged if client code is recompiled but not neccessarily only with
  a rlinking of client code.
}}
...
\longnewglossaryentry{access specifier}{
  ...
  description={
%DRAFT JMB
One of the keywords 'private', 'public' or 'protected`, used to control **accessability**
of entities within a class.  Those parts of a class that are `private` may be accessed
only from within the class or by friends.  Those parts that are `protected may also be
accessed by derived classes, and those parts that are `public` may be accessed from
anywhere.
}}
...
%DRAFT JMB
Prevents all
write operations in the thread which happen after the barrier from being reordered before the
barrier, and prevent all read operations in the thread before the fence from
...
\longnewglossaryentry{aggregate}{
  ...
  description={
%DRAFT JMB
An array or a class with no user-provided constructors, no base classes,
no private or protected non-static data members, and no virtual functions.
In C++17, public non-virtual base classes are allowed.
}}
...
\longnewglossaryentry{aggregate initialization}{
  ...
  description={
%DRAFT JMB
The initialization of an **aggregate** using **list initialization**.
}}
...
\longnewglossaryentry{aggregate type}{
  ...
  description={
% DRAFT JMB
A **user defined type** which is an **aggregate**.
}}
...
\longnewglossaryentry{algebra}{
  ...
  description={
% DRAFT JMB
  The set of operations which can be applied to a set of values of a given
  type, along with the rules that apply to those operations and how they
  interrelate.
}}
...
\longnewglossaryentry{algorithm selection}{
  ...
  description={
% DRAFT JMB
Selecting an algorithm from amongst a portfolio of potentially applicable
algorithms based on easily observable (compile time or runtime) features of the
input data set (see \cite{leyton-brown03}).
}}
...
\longnewglossaryentry{alias template}{
  ...
  description={
%DRAFT JMB
A template declared with a `using` declaration that is a type alias for another
...
\longnewglossaryentry{alignment}{
  ...
  description={
%DRAFT JMB
The largest integral power of $2$ that evenly divides an address.
}}
...
\longnewglossaryentry{alignment requirement}{
  ...
  description={
%DRAFT JMB
An \lstinline!std::size\_t! value (always a power of $2$) that will evenly divide
the address of any object of a specified type.
}}
...
\longnewglossaryentry{architectural insulation}{
  ...
  description={
%DRAFT JMB
The physical analog of **encapsulation**, where the design of a component leads
to the ability to alter its implementation without the need to recompile
client code.
}}
...
\longnewglossaryentry{argument dependent lookup}{
  ...
  description={
%DRAFT JMB
When determing the **overload set** to consider for a function invoked with an
unqualified name all associated namespaces of the function arguments are searched
in addition to the current scope.
}}

\longnewglossaryentry{argument-dependent lookup (ADL)}{
  name={Argument-Dependent Lookup (ADL)},
  description={
@Lori: dpulicate of {argument dependent lookup}, consolidate glossary ids please.
}}
...
\longnewglossaryentry{arithmetic type}{
  ...
  description={
%DRAFT JMB
One of the integral or floating point **fundamental types**.
}}
...
\longnewglossaryentry{array to pointer decay}{
  ...
  description={
%DRAFT JMB
An implicit conversion from an array type with known or unknown bounds to a pointer
...
\longnewglossaryentry{array type}{
  ...
  description={
%DRAFT JMB
An **aggregate** containing a fixed number of contiguously allocated
subobjects of a given element type.
}}
...
\longnewglossaryentry{atomic}{
  ...
  description={
%DRAFT JMB
Operations that always run completely.  Concurrent ***atomic***  reads and writes
will never observe an operation that has only partially completed.
}}
...
TODO
@Lori:
  lambda: 2 references to this should be changed to include all 3 words, automatic
     storage duration.  One has (i.e., non-static) after automatic, I suggest removing it.
  functionstatic: ``Automatic objects with local scope'' should be ``Objects with \emcppsgloss{automatic storage duration}''
...
\longnewglossaryentry{automatic storage duration}{
  ...
  description={
%DRAFT JMB
Variables in local scope that are created when execution passes over their declarations
and destroyed when execution leaves their scope.
}}
...
\newglossaryentry{basic exception safety guarantee}{
  name={Basic Exception Safety Guarantee},
  description={
TODO
}}
...
\longnewglossaryentry{braced initializer list}{
  name={Braced initializer list},
  description={
TODO
}}
...
\newglossaryentry{explicit instantiation }{
...
\longnewglossaryentry{freestanding}{
  name={Freestanding},
  description={
TODO
}}
...
\longnewglossaryentry{pointer semantics}{
...
\AtBeginDocument{\glsadd{quality of implementation (QoI)}}

\longnewglossaryentry{RTTI}{
  name={RTTI},
  description={
TODO
}}
...
\longnewglossaryentry{standard layout class types}{
  name={Standard-Layout Class Types},
  description={
TODO
}}
...
\newglossaryentry{strong exception safety guarantee}{
  name={Strong Exception Safety Guarantee},
  description={
TODO
}}
...
\longnewglossaryentry{temporary}{
  name={Temporary},
  description={
TODO
}}
...
\longnewglossaryentry{y combinator}{
  name={Y combinator},
  description={
TODO
}}
...
\longnewglossaryentry{abstract class}{
  name={abstract class},
  description={
TODO
}}

\longnewglossaryentry{accessible copy constructor}{
  name={accessible copy constructor},
  description={
TODO
}}

\longnewglossaryentry{aliasing}{
  name={aliasing},
  description={
TODO
}}

\longnewglossaryentry{allocating objects}{
  name={allocating objects},
  description={
TODO
}}

\longnewglossaryentry{amortized constant time}{
...
\longnewglossaryentry{basic exception-safety guarantee}{
  name={basic exception-safety guarantee},
  nonumberlist,
  description={
TODO
}}
\AtBeginDocument{\glsadd{basic exception-safety guarantee}}

\longnewglossaryentry{basic guarantee}{
  name={basic guarantee},
  description={
TODO
}}

\longnewglossaryentry{composite pattern}{
  name={composite pattern},
  description={
TODO
}}

\longnewglossaryentry{conditional expression}{
  name={conditional expression},
  description={
TODO
}}

\longnewglossaryentry{conditional noexcept specifications}{
  name={conditional noexcept specifications},
  description={
TODO
}}
...
\longnewglossaryentry{copy swap idiom}{
  name={copy swap idiom},
  description={
TODO
}}

\longnewglossaryentry{decay}{
  name={decay},
  description={
TODO
}}

\longnewglossaryentry{defaulted}{
  name={defaulted},
  description={
TODO
}}

\longnewglossaryentry{defensive programming}{
  name={defensive programming},
  description={
TODO
}}

\longnewglossaryentry{devirtualize}{
  name={devirtualize},
  description={
TODO
}}

\longnewglossaryentry{dynamic binding}{
  name={dynamic binding},
  description={
TODO
}}

\longnewglossaryentry{dynamic dispatch}{
  name={dynamic dispatch},
  description={
TODO
}}

\longnewglossaryentry{dynamic exception specification}{
  name={dynamic exception specificati},
  description={
TODO
}}

\longnewglossaryentry{exception agnostic}{
  name={exception agnostic},
  description={
TODO
}}

\longnewglossaryentry{exception safe}{
  name={exception safe},
  description={
TODO
}}
...
\longnewglossaryentry{generic programming}{
  name={generic programming},
  description={
TODO
}}

\longnewglossaryentry{hierarchical reuse}{
...
\longnewglossaryentry{managed allocator}{
  name={managed allocator},
  description={
TODO
}}

\longnewglossaryentry{memory diffusion}{
  name={memory diffusion},
  description={
TODO
}}

\longnewglossaryentry{mocking}{
  name={mocking},
  description={
TODO
}}

\longnewglossaryentry{move only}{
  name={move only},
  description={
TODO
}}

\longnewglossaryentry{move only type}{
  name={move only type},
  description={
TODO
}}
...
\longnewglossaryentry{object orientation}{
...
\longnewglossaryentry{placeholder}{
  name={placeholder},
  description={
TODO
}}

\longnewglossaryentry{polymorphic type}{
  name={polymorphic type},
  description={
TODO
}}

\longnewglossaryentry{positive semidefinite}{
  name={positive semidefinite},
  description={
TODO
}}

\longnewglossaryentry{potentially evaluated}{
  name={potentially evaluated},
  description={
TODO
}}

\longnewglossaryentry{private inheritance}{
  name={private inheritance},
  description={
TODO
}}
...
\longnewglossaryentry{proctor class}{
  name={proctor class},
  description={
TODO
}}

\longnewglossaryentry{protocol hierarchy}{
...
\longnewglossaryentry{pure virtual function}{
  name={pure virtual function},
  description={
TODO
}}

\longnewglossaryentry{reuse}{
  name={reuse},
  description={
TODO
}}

\longnewglossaryentry{rule of zero}{
  name={rule of zero},
  description={
TODO
}}
...
\longnewglossaryentry{salient values}{
  name={salient values},
  description={
TODO
}}

\longnewglossaryentry{scoped guard}{
  name={scoped guard},
  description={
TODO
}}

\longnewglossaryentry{stack unwinding}{
...
\longnewglossaryentry{strong exception-safety guarantee}{
  name={strong exception-safety guara},
  nonumberlist,
  description={
TODO
}}
\AtBeginDocument{\glsadd{strong exception-safety guarantee}}

\longnewglossaryentry{strong guarantee}{
  name={strong guarantee},
  description={
TODO
}}

\longnewglossaryentry{unevaluated operands}{
  name={unevaluated operands},
  description={
TODO
}}
...
\longnewglossaryentry{virtual dispatch}{
  name={virtual dispatch},
  description={
TODO
}}

\longnewglossaryentry{vtable}{
  name={vtable},
  description={
TODO
}}

\longnewglossaryentry{vtable pointer}{
  name={vtable pointer},
  description={
TODO
}}

\longnewglossaryentry{wide contract}{
  name={wide contract},
  description={
TODO
}}
...
\longnewglossaryentry{C++11 memory allocators}{
  name={C++11 memory allocators},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{C++17 pmr allocators}{
  name={C++17 pmr allocators},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{NRVO}{
  name={NRVO},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{braced list initialization}{
  name={braced list initialization},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{const lvalue}{
  name={const lvalue},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{copy assigned}{
  name={copy assigned},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{copy assignment}{
...
\longnewglossaryentry{default constructed}{
...
\longnewglossaryentry{default constructor}{
...
\longnewglossaryentry{default destructor}{
...
\longnewglossaryentry{defect report}{
  name={defect report},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{defensive check}{
...
\longnewglossaryentry{destructor}{
  name={destructor},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{equality comparable}{
...
\longnewglossaryentry{expression}{
  name={expression},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{function designator}{
...
\longnewglossaryentry{guaranteed copy elision}{
  name={guaranteed copy elision},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{have identity}{
  name={have identity},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{implicitly movable entity}{
  name={implicitly movable entity},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{in place}{
  name={in place},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{lvalue expression}{
...
\longnewglossaryentry{lvalue to rvalue conversion}{
  name={lvalue to rvalue conversion},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{materialize}{
  name={materialize},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{move assign}{
  name={move assign},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{move assignment operator}{
...
\longnewglossaryentry{move assignment}{
...
\longnewglossaryentry{move construction}{
  name={move construction},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{move constructor}{
...
\longnewglossaryentry{named return value optimization}{
  name={named return value optimization},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{normative}{
  name={normative},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{null pointer value}{
  name={null pointer value},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{null terminated string}{
...
\longnewglossaryentry{out of contract}{
...
\longnewglossaryentry{owned resources}{
...
\longnewglossaryentry{reachable}{
  name={reachable},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{salient attribute}{
  name={salient attribute},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{sanitizer}{
  name={sanitizer},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{sink argument}{
  name={sink argument},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{size constructor}{
...
\longnewglossaryentry{temporary materialization}{
  name={temporary materialization},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{temporary object}{
...
\longnewglossaryentry{trivial copy operation}{
  name={trivial copy operation},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{undeclared}{
  name={undeclared},
  nonumberlist,
  description={
TODO
...
\longnewglossaryentry{unique ownership}{
...
\longnewglossaryentry{valid but unspecified}{
  name={valid but unspecified},
  nonumberlist,
  description={
TODO
}}

\longnewglossaryentry{xvalue}{
  name={xvalue},
  nonumberlist,
  description={
TODO
...
%vertical encoding --- A convention whereby the meaning of some bits in an encoding are predicated on the values of certain other bits, typically occurring earlier in the encoding.
%horizontal encoding --- A convention whereby the meaning of bits that occur throughout an encoding are independent of the values of bits that occur elsewhere in that encoding.
%virtual-function table --- we will want to point out that a vtable consists of
%rows that typically contain c-style functions along with metadata that indicates
%the offset of the vtable pointer within current object.  For single inheritance,
%that offset is always zero, but for multiple inheritance with a secondary base
%class the "this" pointer must be adjusted before the object address is supplied
%to the member function TBD. :)  Oh, and Alisdair Meredith didn't know this as
%of TODAY, 21-05-18_1040, so don't tell me everyone knows this! :)  A.k.a virtual table, vtable, or vtbl.
%<!-- AJM did already know this, but was worried about impact on other coding
%idioms involving type erasure and cast pointers. -->
%
%
%
%!**Accessible**!: A class member (`m`) is !**accessible**! when use of it's name, from a client context (`c`) is not precluded due to **access control** --- e.g., `m` is `private` and `c` is has only `public` access.  (**Accessible** doesn't necessarily imply **usable**, as `m` might be, e.g., **ambiguous**, **deleted**, or an **ill-formed** **template specialization**.)%
%
%!**conversion constructor**!: A !**conversion constructor**! is any (possibly `explicit` **constructor**, other than the copy or move constructor, invocable with a single argument.
%
%!**conversion operator**!: A !**conversion operator**! is a possibly **cv-quallified**, possibly `explicit`, **member operator** of the form `operator T()`, where `T` is a possibly **cv-qualfied type.
%
%!**User declared**!: A **member function** is !**user declared**! if a declaration of that function appears within the scope of its class definition (irrespective of whether the function is **defined**); see **user provided**.
%
%<!-- PGH: I don't think we want a **user-defined** glossary item unless it comprises all of **user-defined member function**, **user-defined conversion**, and **user-defined type**.  I think the following is the correct definition of **user-defined member function**. -->
%!**user defined**!: (Obsolete) In C++03, a !**user defined**! member function meant what is now referred to as either **user declared** or **user provided**. (Absence C++11's `=default` and `=delete` features, there was no need for such a distinction.)
%
%!**user-defined conversion**!: A !**user-defined conversion**! is the result of invoking a **conversion constructor** or **conversion operator** (ether implicitly or explicitly).
%
%<!-- PGH: Shouldn't **UDT** be mentioned as a synonym for **user-defined type**? -->
%!**User-defined type**!: A **user-defined type** is any `class`, `struct`, `union`, or enumerated type (`enum` or `enum` `class`).
%
%!**User-provided**: A **member function** is !**user-provided**! if it is **user-declared** and its first declaration is not immediately followed by either `= default` or `= delete`.
%
