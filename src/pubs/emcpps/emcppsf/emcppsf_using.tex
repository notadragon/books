...
change data structures. If we were to instead use an \emcppsgloss{alias
...
Alias templates can provide a shorthand notation for \emcppsgloss[type trait]{type
traits}, avoiding \emcppsgloss{boilerplate code} in the usage site. As an
