...
\begin{emcppslisting}[language=C++]
#include <iostream>  // (Ã¹{\codeincomments{std::cout}}Ã¹), (Ã¹{\codeincomments{std::endl}}Ã¹)
...
const char s0[] = R"({ "key": "value" })";
    // OK, equivalent to (Ã¹{\codeincomments{"\{ $\backslash$"key$\backslash$": $\backslash$"value$\backslash$" \}"}}Ã¹)
\end{emcppslisting}
...
const char s2[] = R"(line one)"         "\n"
                    "line two"          "\n"
                  R"(    line three)";
    // OK, equivalent to (Ã¹{\codeincomments{"line one$\backslash$nline two$\backslash$n~~~~line three"}}Ã¹)    
\end{emcppslisting}
...
const char     u8s[] = u8R"(\U0001F378)";  // Represents "\U0001F378", *not* "(Ã¹{\martini}Ã¹)"
...
//                             ^^
// The (Ã¹{\codeincomments{)"}}Ã¹) character sequence terminates a typical raw string literal.
\end{emcppslisting}
...
%const char s3[] = R"(printf("printf(\"Hello, World!\")"))";  (Ã¹{\codeincomments{\color{skyblue}\ttfamily\itshape // collision}}Ã¹)
%(Ã¹{\codeincomments{\color{skyblue}\ttfamily\itshape //}}Ã¹)                                                    (Ã¹{\codeincomments{\color{skyblue}\ttfamily\itshape\textasciicircum\textasciicircum}}Ã¹)
%(Ã¹{\codeincomments{\color{skyblue}\ttfamily\itshape //}}Ã¹)                       (Ã¹{\codeincomments{\color{skyblue}\ttfamily\itshape Syntax error after literal ends}}Ã¹)
%\end{lstlisting}
\begin{emcppslisting}[language=C++,]
const char s3[] = R"(printf("printf(\"Hello, World!\")"))";  (Ã¹{\codeincomments{// collision}}Ã¹)
(Ã¹{\codeincomments{//}}Ã¹)                                                    (Ã¹{\codeincomments{\textasciicircum\textasciicircum}}Ã¹)
(Ã¹{\codeincomments{//}}Ã¹)                       (Ã¹{\codeincomments{Syntax error after literal ends}}Ã¹)
\end{emcppslisting}
...
%%%%%%%%%% JOSH: this code had ben set with color intentionally added. Pls make sure it now appears the way it should. 
%\begin{lstlisting}[language=C++]
%const char s5[] = R"###(printf("printf(\"Hello, World!\")"))###";  (Ã¹{\codeincomments{\color{skyblue}\ttfamily\itshape // cleaner}}Ã¹)
%\end{lstlisting}
\begin{emcppslisting}[language=C++]
const char s5[] = R"###(printf("printf(\"Hello, World!\")"))###";  (Ã¹{\codeincomments{// cleaner}}Ã¹)
\end{emcppslisting}
...
//                |          string contents
//                |
//                | uppercase (Ã¹{\codeincomments{R}}Ã¹)
\end{emcppslisting}
...
const char s7[] = R"("Hello, World!")";
    // OK, equivalent to (Ã¹{\codeincomments{$\backslash$"Hello, World!$\backslash$"}}Ã¹)
\end{emcppslisting}
...
const char s8[] = R"!("--- R"(Raw literals are not recursive!)" ---")!";
    // OK, equivalent to (Ã¹{\codeincomments{$\backslash$"--- R$\backslash$"(Raw literals are not recursive!)$\backslash$" ---$\backslash$"}}Ã¹)
\end{emcppslisting}
...
printf(R"("Live-Free, don't (ever)","Die!");
    (Ã¹{\codeincomments{// Prints: "Live-Free, don't (ever}}Ã¹)

printf((R"("Live-Free, don't (ever)","Die!"));
    (Ã¹{\codeincomments{// Prints: Die!}}Ã¹)
\end{emcppslisting}
...
const char* productIdRegex = "[0-9]{5}\\(\".*\"\\)";
    // This regular expression matches strings like (Ã¹{\codeincomments{12345("Product")}}Ã¹).
\end{emcppslisting}
