...
We identify two distinct forms of \emcppsgloss{opaque declarations}, i.e.,
...
A classic (C++03) C-style \lstinline!enum! cannot have \emcppsgloss{opaque declarations}, nor can its definition be repeated within the same
...
on \emcppsgloss{opaque declarations} exists because the specific values of
...
for \emcppsgloss{opaque enumerations}.
...
\emcppsgloss{opaque enumerations}, however, is qualitatively more severe than
