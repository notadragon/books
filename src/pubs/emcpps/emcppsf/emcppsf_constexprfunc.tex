...
struct S0 { int i;           S0() : i(0) { } };  // (ù{\codeincomments{S0}}ù) is (ù{\emphincomments{not}}ù) a literal type.
struct S1 { int i; constexpr S1() : i(0) { } };  // (ù{\codeincomments{S1}}ù) (ù{\emphincomments{is}}ù) a literal type.
