...
\begin{emcppshiddenlisting}[emcppsbatch=bl1]
// This is a hidden listing in batch bl1
\end{emcppshiddenlisting}

\begin{emcppslisting}[emcppsbatch=bl1]
...
%}
%\end{emcppslisting}
\begin{emcppshiddenlisting}[emcppsbatch=vm]
#include <cstdint>
...
\end{emcppshiddenlisting}
\begin{emcppslisting}[emcppsbatch=vm]
#include <cstdint>  // (ù{\codeincomments{std::uint8\_t}}ù)
