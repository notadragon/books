\emcppsFeature{
    tocshort={{\TOCCode alignof - TOCSHORT}},
    toclong={The (Compile-Time) {\TOCCode alignof} Operator - TOCLONG},
    rhshort={{\SecCode alignof - RHSHORT}},
    short={{\SecCode alignof - SHORT}},
    long={The (Compile-Time) {\SecCode alignof} Operator - LONG},
}{alignof}

\titleref{constexprvar} \\
