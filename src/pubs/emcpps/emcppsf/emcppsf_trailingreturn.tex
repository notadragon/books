...
\noindent Using this divide-and-conquer approach, writing such functions{\cprotect\footnote{Declaring a \romeogloss{higher-order function} that
...
\seealsoref{decltype}{\locationa}Safe C++11 type inference feature that is often used in conjunction with or as an alternative to trailing return types}
...
\seealsoref{Function-Return-Type-Deduction}{\locationf}Unsafe C++14 type inference feature that shares syntactical similarities with trailing return types, leading to potential pitfalls when migrating from C++11 to C++14}
\end{itemize}
