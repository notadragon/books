...
\emcppsFeature{
    short={\lstinline!override!},
    tocshort={\TOCCode override},
    long={The {\tt override} Member-Function Specifier},
    rhshort={\RHCode override},
}{override}
...
The \emcppsgloss{contextual keyword} \lstinline!override! can be provided at the
...
\begin{emcppslisting}
int (ù{\ttfamily{override}}ù) = 1;  // OK
int (ù{override}ù) = 1;  // OK
int override = 1;  // OK
\end{emcppslisting}
