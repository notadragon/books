...
Finally, note that the use of \emcppsgloss[explicit instantiation directives]{explicit-instantiation \emph{directives}} have absolutely no affect on the logical meaning of a
...
\emcppsgloss[explicit instantiation declarations]{explicit-instantiation declarations}. Only \emph{after}
...
So far, we have seen the use of \emcppsgloss[explicit instantiation declarations]{explicit-instantiation declarations} and \emcppsgloss[explicit instantiation definitions]{explicit-instan\-tiation definitions} applied to only a
...
Having installed the necessary \emcppsgloss[explicit instantiation definitions]{explicit-instantiation definitions} in the component's \lstinline!my_vector.cpp! file, we
...
corresponding \emcppsgloss[explicit instantiation declarations]{explicit-instantiation declarations} to
...
in the example above are \emcppsgloss[explicit instantiation declarations]{explicit-instantiation declarations}, which serve only to suppress the generation of any
...
To illustrate the effect of \emcppsgloss[explicit instantiation declarations]{explicit-instantiation declarations} and \emcppsgloss[explicit instantiation definitions]{explicit-instantiation definitions} on the contents of object and executable files,
...
\emcppsgloss[explicit instantiation declarations]{explicit-instantiation declarations} --- one for the
...
times. \emcppsgloss[explicit instantiation declarations]{Explicit-instantiation declarations} do \emph{not}
...
\noindent Whether optimization involving \emcppsgloss[explicit instantiation directives]{explicit-instantiation directives} reduces library sizes on disc has no noticeable effect or
...
Even before the introduction of \emcppsgloss[explicit instantiation declarations]{explicit-instantiation \emph{declarations}}, strategic use of \emcppsgloss[explicit instantiation definitions]{explicit-instantiation \emph{definitions}} made it possible to \emcppsgloss{insulate} the
...
\noindent Without the two \emcppsgloss[explicit instantiation definitions]{explicit-instantiation definitions} in
...
\emcppsgloss[explicit instantiation definitions]{explicit-instantiation definitions} in the header file
...
result from client use; hence, the two \emcppsgloss[explicit instantiation declarations]{explicit-instantiation declarations} above for \lstinline!float! and \lstinline!double!,
...
If one suspects that \emcppsgloss[explicit instantiation directives]{explicit-instantiation directives}
...
code bloat is to provide member-specific \emcppsgloss[explicit instantiation directives]{explicit-instantiation directives} for each valid member of \lstinline!W<U>!, an approach
