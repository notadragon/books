\emcppsFeature{
    ...
    toclong={Threadsafe Function-Scope {\TOCCode static} Variables},
    short={Function {\SecCode static} '11},
...
across translation units an abundant source of insidious errors. Objects that undergo \romeogloss{constant initialization} have no issue:
