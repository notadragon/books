...
yet specifically addressed those \emcppsgloss{special member functions}:
...
\emph{member initialization list} or \emcppsgloss[placement new]{placement \lstinline!new!}) or
