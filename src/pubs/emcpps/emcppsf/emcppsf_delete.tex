...
% Jan 27, code compiled by Josh
% Jan 27, new section added 
\emcppsFeature{
...
\begin{itemize}
\item{%Section~\ref{Defaulted-Special-Member-Functions}, ``\titleref{Defaulted-Special-Member-Functions}" on page~\pageref{Defaulted-Special-Member-Functions} â€”
...
\item{%Section~\ref{Rvalue-References}, ``\titleref{Rvalue-References}" on page~\pageref{Rvalue-Referencess} â€”
