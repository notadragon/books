...
The modern C++ memory model describes two \emcppsgloss[synchronization paradigm]{synchronization paradigms}{\cprotect\footnote{The current suite of supported
