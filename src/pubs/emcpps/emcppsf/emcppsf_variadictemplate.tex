...
template <typename... Ts> class C;
    ...
    // not also a definition , the parameter name, (ù{\codeincomments{Ts}}ù) (for "types"), isn't used.
\end{emcppslisting}
...
\begin{emcppslisting}
#include <iostream>  // (ù{\codeincomments{std::cout}}ù), (ù{\codeincomments{std::ostream}}ù), (ù{\codeincomments{std::endl}}ù)
