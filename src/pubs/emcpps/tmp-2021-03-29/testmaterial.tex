...
\emcppsFeature{
    short={\lstinline!code0! in Short},
    tocshort={{\TOCCode code0} in Short},
    long={Longer Wordier Feature Title with {\SecCode Code0}},
    toclong={Longer Wordier Feature Title with \lstinline!Code0!},
    rhshort={{\RHCode code0} in Short},
}{testmaterial}
\setcounter{table}{0}
...
Maecenas eget ultricies risus; see \featureref{\locationa}{attributes}. Donec varius vehicula diam.
...
\end{emcppslisting}
\end{minipage}
\footnotetext{testing a footnote}
