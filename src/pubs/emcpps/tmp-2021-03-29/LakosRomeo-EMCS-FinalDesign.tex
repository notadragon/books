...
\renewcommand{\rightmark}{\lastrightmark}
...
%%%% was using this below
%\renewcommand{\sectionmark}[1]{\markright{{\sfRHRomeo #1}}} % to remove section number 
%%%% trying Josh's fix below but changed it to the right font
\renewcommand{\sectionmark}[1]{\markright{{\emcppsPickRH{\sfRHRomeo #1}}}}
...
%%%%% back to glossary stuff
\include{preamble-glossary}
\include{glossary}
\renewcommand{\glossarymark}[1]{\markboth{}{\sfRHRomeo #1}}
...
\newfontface{\sfitwelveRomeo}[Ligatures=Common,Scale=1.2]{Gill Sans Nova Medium Italic}
%%%%%
...
% fonts for the glossary terms 
\newfontface{\romeoglossfirstfont}[Ligatures=Common,Scale=1]{CMU Concrete Bold}
\newfontface{\romeoglossfont}[Ligatures=Common,Scale=1]{CMU Concrete Roman}
\newfontface{\romeoglossfirst}[Ligatures=Common,Scale=1]{CMU Concrete Bold}
\newfontface{\romeoglossnonfirst}[Ligatures=Common,Scale=1]{CMU Concrete Roman}  %% so this will work with the features we already have
...
\newcommand\romeoglossf[1]{{\romeoglossfirst{#1}}}
\newcommand\romeoglossn[1]{{\romeoglossnonfirst\textbf{#1}}}
\newcommand{\romeogloss}{\romeoglossn}
...
\newcommand\seealsoref[2]{``\titleref{#1}"~({#2}, p.~\pageref{#1})~}
...
\input{preamble-listings-emcpps-minuscurrfile}
...
%language=C++,  
language=[11]C++, % change from josh 5 March 2021
 framerule=0.5pt,
    keywordstyle={\ttfamily\bfseries},
        morekeywords={char8\_t,co\_await,co\_return,co\_yield,  %% change from josh
                  concept,consteval,constinit,requires},  %% change from josh
...
% language=C++,  %% change from josh
style=Romeo, % change from Josh
...
\input{preamble-emcppssectioning}
