...
%\hspace*{\fill}\\  
%\par\begin{wrapfigure}[11]{L}[0pt]{0pt}\includegraphics[trim=0pt 0pt 0pt 13pt]{AuthorPhoto}\end{wrapfigure}
...
%\begin{wrapfigure}[11]{L}[0pt]{0pt}\includegraphics[trim=0pt 0pt 0pt 13pt]{AuthorPhoto}\end{wrapfigure}
